...
Веталение нужно для того, чтобы внедрить новый функционал, не затрагивая основной. Мы можем создавать ветку, перемещаться в нее, сливать ветки, удалять ветки после сливания с основной.
